...
This document focuses on this second scenario, where the business processes are the vehicle to transition from a large-scale business analysis exercise and the commencement of the architecture and design phase. And how to prepare the business processes to hand-shake them directly with the following design and analysis phases of the project. <br>
In this regard, after the business processes documentation is completed, they are usually used as input for many other consequent works, including Architects, who receive them and consider them as input for business and system requirements. <br>
